...
//Ryan Howard, 10/9/2020, Practice documenting with JavaDocs and testing code with JUnit
...
public class RPSLSpock {
    ...
    /**
     * Compares user input to computer pick
     * @param c_pick computer pick
     * @param h_pick user input
     * @return true if computer wins and false if user wins
     */
